...
import companyname.com.kpl.PremierLeagueTableTwoFragment;
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.fs_tvPremier:
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fmkpl_flMain, PremierLeagueTableTwoFragment.newInstance()).addToBackStack(null).commit();
                break;
