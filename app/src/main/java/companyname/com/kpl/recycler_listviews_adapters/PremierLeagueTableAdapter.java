...
public class PremierLeagueTableAdapter extends RecyclerView.Adapter<PremierLeagueTableAdapter.PremierLeagueViewHolder> {

    private Context context;


    public PremierLeagueTableAdapter(Context context)
    {
    ...
    public PremierLeagueViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.premier_league_table_item_layout, parent, false);
