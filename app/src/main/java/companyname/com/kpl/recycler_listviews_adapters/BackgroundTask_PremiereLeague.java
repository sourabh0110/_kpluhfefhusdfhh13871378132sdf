...
public class BackgroundTask_PremiereLeague extends AsyncTask<Void,PremiereLeague,Void> {
    ...
    public BackgroundTask_PremiereLeague(Context ctx) {
        this.ctx = ctx;
    ...
    protected void onPreExecute() {
        recyclerView = (RecyclerView) activity.findViewById(R.id.rv_pl);
    ...
    @Override
    protected void onProgressUpdate(PremiereLeague... values) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            while(count<jsonArray.length())
            {
                ...
                PremiereLeague premiereLeague=new PremiereLeague(JO.getString("tm_logo"),JO.getInt("tm_code"),JO.getString("tm_name"));
